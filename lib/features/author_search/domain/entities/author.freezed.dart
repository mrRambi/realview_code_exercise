...
/// OpenLibrary author key (e.g. "OL26320A").
 String get key; String get name; String? get birthDate; String? get topWork; int? get workCount;/// OLID used to build the photo URL via the covers API.
 String? get photoId;
...
@override
int get hashCode => Object.hash(runtimeType,key,name,birthDate,topWork,workCount,photoId);

@override
String toString() {
  return 'Author(key: $key, name: $name, birthDate: $birthDate, topWork: $topWork, workCount: $workCount, photoId: $photoId)';
}
...
@useResult
$Res call({
 String key, String name, String? birthDate, String? topWork, int? workCount, String? photoId
});
...
/// Create a copy of Author
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = null,Object? name = null,Object? birthDate = freezed,Object? topWork = freezed,Object? workCount = freezed,Object? photoId = freezed,}) {
...
as int?,photoId: freezed == photoId ? _self.photoId : photoId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String key,  String name,  String? birthDate,  String? topWork,  int? workCount,  String? photoId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Author() when $default != null:
return $default(_that.key,_that.name,_that.birthDate,_that.topWork,_that.workCount,_that.photoId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String key,  String name,  String? birthDate,  String? topWork,  int? workCount,  String? photoId)  $default,) {final _that = this;
switch (_that) {
case _Author():
return $default(_that.key,_that.name,_that.birthDate,_that.topWork,_that.workCount,_that.photoId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String key,  String name,  String? birthDate,  String? topWork,  int? workCount,  String? photoId)?  $default,) {final _that = this;
switch (_that) {
case _Author() when $default != null:
return $default(_that.key,_that.name,_that.birthDate,_that.topWork,_that.workCount,_that.photoId);case _:
  return null;
...
class _Author implements Author {
  const _Author({required this.key, required this.name, this.birthDate, this.topWork, this.workCount, this.photoId});
...
/// Create a copy of Author
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? name = null,Object? birthDate = freezed,Object? topWork = freezed,Object? workCount = freezed,Object? photoId = freezed,}) {
